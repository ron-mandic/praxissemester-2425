...
<article>
	<a href="/test-1" class="disabled"><h2>Chat Completion</h2></a>
	<p>
...
<article>
	<a href="/test-2" class="disabled"><h2>Chat Stream</h2></a>
	<p>
...
<article>
	<a href="/test-3" class="disabled"><h2>Chat Completion with JSON</h2></a>
	<p>
...
<article>
	<a href="/test-4" class="disabled"><h2>Embeddings</h2></a>
	<p>
...
<article>
	<a href="/test-5" class="disabled"><h2>Chat Completion + Embeddings</h2></a>
	<p>
...
<article>
	<a href="/test-6" class="disabled"><h2>Chat Completion + Embeddings + Supabase</h2></a>
	<p>
