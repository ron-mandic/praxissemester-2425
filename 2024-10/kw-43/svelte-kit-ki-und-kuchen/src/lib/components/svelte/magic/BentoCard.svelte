...
>
	...
	>
		<svelte:component
			this={Icon}
			class="mb-2 -ml-1 h-12 w-12 origin-left transform-gpu text-neutral-700 transition-all duration-300 ease-in-out group-hover:scale-75"
		/>

		<h3 class="text-xl font-semibold text-neutral-700 dark:text-neutral-300">
			{name}
		</h3>
		<p class="my-2 max-w-lg text-neutral-400 line-clamp-2">{description}</p>
	</div>
